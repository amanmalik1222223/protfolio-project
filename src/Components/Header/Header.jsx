        ...
        <>
            ...
            items-baseline px-11 text-white font-cormorant py-4 align-middle'>
                ...
                <div className='text-2xl font-medium gap-6 flex text-lightGray'>
                    <div><a href='' className='hover:text-customGray font-roboto cursor-pointer active:text-gray-700'>Home</a></div>
            ...
            <div className='flex-col lg:hidden bg-transparent w-full justify-between items-middle text-white font-cormorant pt-5'>
                <div className='flex min-h-auto z-50 bg-transparent w-full justify-between items-baseline md:px-9 px-7 text-white 
                ...
                {/* Overlay Menu */}
                <div
                    className={`fixed top-[11vh] left-0 w-full h-full bg-white bg-opacity-30 backdrop-blur-md text-orange-200 z-40 
                        flex flex-col items-center font-roboto font-medium
                        transition-all duration-300 ease-in-out text-2xl ${
                        isOpen ? 'opacity-100 visible' : 'opacity-0 invisible'
                    }`}
                >
                    <div className='w-full text-center py-4 cursor-pointer transition ease-in-out duration-300 hover:bg-gray-700 hover:text-white'>
                        <a href='#home'>Home</a>
                    </div>
                    <div className='w-full text-center py-4 cursor-pointer transition ease-in-out duration-300 hover:bg-gray-700 hover:text-white'>
